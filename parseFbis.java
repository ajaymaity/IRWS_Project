  ...
  // String test="";
   ...
   // Elements paragraphs = document.getElementsByTag("HT");
    ...
    for (Element element : elements) {
    	     ...
    	     System.out.println(element.getElementsByTag("f").select("*").not("phrase").eachText()+"\n");
	...
	//deleteDir(new File("/Users/playsafe/Desktop/Java/Parsing/src/outputs/parsed_docs/fbis.json"));
